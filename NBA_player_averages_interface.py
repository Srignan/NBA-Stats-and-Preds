...
def allStats():  # Displays league averages without any filters
...
def sortedStats(PPG_PG, RPG_PG, APG_PG, SPG_PG, BPG_PG, FG_PG, THREE_PG, FT_PG, TOV_PG, PGCounter,
                ...
                PPG_C, RPG_C, APG_C, SPG_C, BPG_C, FG_C, THREE_C, FT_C, TOV_C,
                CCounter):  # Gives league averages based on games and minutes played
    index = csv.index
    index_len = len(index)
    player_last = 0
    ...
    for i in range(0, index_len):
        ...
        if (csv.iloc[i, 2] == "PG" and csv.iloc[i, 5] > games_played and csv.iloc[
            i, 7] >= minutes_played and player_last != player_current):
        ...
        if (csv.iloc[i, 2] == "SG" and csv.iloc[i, 5] > games_played and csv.iloc[
            i, 7] >= minutes_played and player_last != player_current):
        ...
        if (csv.iloc[i, 2] == "SF" and csv.iloc[i, 5] > games_played and csv.iloc[
            i, 7] >= minutes_played and player_last != player_current):
        ...
        if (csv.iloc[i, 2] == "PF" and csv.iloc[i, 5] > games_played and csv.iloc[
            i, 7] >= minutes_played and player_last != player_current):
        ...
        if (csv.iloc[i, 2] == "C" and csv.iloc[i, 5] > games_played and csv.iloc[
            i, 7] >= minutes_played and player_last != player_current):
